...
mtext(side = 1, "Data source: Environmental Protection Agency (EPA)", line= 2.4, font=1, cex=.7, adj=-.35)

# Main title
mtext(side=3, 'Baltimore City Vehicle Emissions - 1999 to 2005', line=2, font=1.6, cex=1.2)
